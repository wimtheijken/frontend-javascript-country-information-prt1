...
async function fetchCountries() {
    try {
        ...
        function colorPicker(continent1) {
        ...
        for(let i = 0; i < response.data.length; i++){
            let continent1 = response.data[i].continents[0];
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["53obS","d21cg"], "d21cg", "parcelRequirecb08")
