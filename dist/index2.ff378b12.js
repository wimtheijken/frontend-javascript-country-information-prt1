...
async function fetchCountries() {
    try {
        ...
        <li class="countryBox"><p class="country"><span>${response.data[i].flag} </span><span class="class="${colorPicker(response.region)}"> ${response.data[i].name.common}</span></p>
...
//# sourceMappingURL=index2.ff378b12.js.map
